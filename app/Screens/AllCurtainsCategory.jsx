...
const data = [
  ...
  },
  {
    ...
    price: "PKR 7,500",
    image: require("./../../assets/images/AllCurtainsCategory2.png"),
  },
  {
    id: "3",
    name: " MARINA Window Curtain -1191CT",
    price: "PKR 6,300",
    image: require("./../../assets/images/AllCurtainsCategory3.png"),
  },
  {
    id: "4",
    name: "Window Curtain -441CT",
    price: "PKR 3,500",
    image: require("./../../assets/images/AllCurtainsCategory4.png"),
  },
  {
    id: "5",
    name: "BLACKOUT Flocking Curtains -447CT",
    price: "PKR 7,400",
    image: require("./../../assets/images/AllCurtainsCategory5.png"),
  },
];

const AllCurtainsCategory = () => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>All Curtains</Text>
...
export default AllCurtainsCategory;
