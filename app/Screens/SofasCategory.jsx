...
const data = [
  {
    id: "1",
    name: "Motoo 4 seater sofa-SF981",
    price: "PKR 44,000",
    image: require("./../../assets/images/sofaCategory1.png"),
  },
  {
    id: "2",
    name: "Mila Sofa 2 seater -1171MS",
    price: "PKR 32,500",
    image: require("./../../assets/images/sofaCategory2.png"),
  },
  {
    id: "3",
    name: "Odeon 3 seater sofa -1190OD",
    price: "PKR 63,000",
    image: require("./../../assets/images/sofaCategory3.png"),
  },
  {
    id: "4",
  ...
  {
    id: "5",
    name: "Kaisa Armrset -4421KA",
    price: "PKR 74,000",
    image: require("./../../assets/images/sofaCategory5.png"),
  },
  {
    id: "6",
    name: "Corner Sofa Set -5521AK",
    price: "PKR 40,000",
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Sofas</Text>
