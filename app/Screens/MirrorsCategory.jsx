...
const data = [
  ...
  {
    id: "3",
    name: "Wall Mirror With Marble Stand -1302MD",
    price: "PKR 20,000",
    image: require("./../../assets/images/MirrorsCategory3.png"),
  },
  {
    id: "4",
    name: "Decorative Mirror -4982MD",
    price: "PKR 29,000",
    image: require("./../../assets/images/MirrorsCategory4.png"),
  },
  {
    id: "5",
    name: "Mid Century French Style Mirror -1764MD",
    price: "PKR 27,000",
    image: require("./../../assets/images/MirrorsCategory5.png"),
  },
  {
    id: "6",
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Mirrors</Text>
...
export default MirrorsCategory;
