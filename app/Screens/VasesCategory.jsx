...
const data = [
  {
    ...
    price: "PKR 8,000",
    image: require("./../../assets/images/VasesCategory1.png"),
  },
  {
    id: "2",
    name: "Karaca Artificial Plant -1146DR",
    price: "PKR 13,000",
    image: require("./../../assets/images/VasesCategory2.png"),
  },
  {
    id: "3",
    name: " Lova Dresser & Mirror -1312MD",
    price: "PKR 20,000",
    image: require("./../../assets/images/VasesCategory3.png"),
  },
  {
    id: "4",
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Vases</Text>
